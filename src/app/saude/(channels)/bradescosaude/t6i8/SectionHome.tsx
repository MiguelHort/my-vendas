        ...
        <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_1fr]">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="flex flex-wrap justify-center gap-2 lg:justify-start">
              ...
              <Badge className="rounded-full bg-white/10 text-white border border-white/20 px-4 py-1.5 text-[10px] backdrop-blur">
                <BadgeCheck className="mr-1.5 h-3.5 w-3.5 text-zinc-500" />
                100% gratuito
              </Badge>

              <Badge className="rounded-full bg-white/10 text-white border border-white/20 px-4 py-1.5 text-[10px] backdrop-blur">
                <Lock className="mr-1.5 h-3.5 w-3.5 text-zinc-500" />
            ...
            <h1 className="mt-6 text-3xl font-bold leading-tight tracking-tight text-white sm:text-5xl lg:text-5xl">
              Seu Plano de Saúde{" "}
              <span className="text-zinc-500">Bradesco Saúde</span>, do jeito que a sua
              Família merece.
            </h1>
            ...
            <div className="mt-7 grid gap-3 sm:grid-cols-2 lg:max-w-xl">
              <div className="flex items-start gap-3 rounded-2xl border border-white/15 bg-white/10 p-4 backdrop-blur">
                <span className="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-xl bg-zinc-500/15 text-zinc-500">
            ...
            <div className="mt-10">
              <Button
                ...
                size="lg"
                className="h-16 w-full rounded-2xl sm:w-auto bg-zinc-500 hover:bg-orange-600 text-white font-semibold flex items-center justify-center px-7"
              >
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-white/10 shadow-xl backdrop-blur">
              <div className="relative h-[320px] w-full sm:h-[380px]">
                ...
                />
                {/* overlay sutil */}
                <div className="absolute inset-0 bg-gradient-to-t from-red-900/55 via-red-900/10 to-transparent" />
                <div className="absolute -right-12 -top-12 h-40 w-40 rounded-full bg-zinc-500/20 blur-3xl" />
              </div>
              ...
              <div className="p-4 sm:p-5">
                <div className="flex items-start gap-3">
                  <div className="flex h-11 w-18 items-center justify-center rounded-2xl bg-white/80 border border-white/15">
                    <Image
                      src="/imgs/planos/bradescosaude.png"
                      alt="Logo Hapvida"
                      width={120}
                      height={60}
                ...
                <div className="mt-4 grid gap-2">
                  <div className="flex items-center gap-2 text-sm text-white/80">
                    <span className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-zinc-500/15 text-zinc-500">
                      <CheckCircle2 className="h-4 w-4" />
                    </span>
            ...
            <div className="pointer-events-none absolute -right-10 bottom-8 h-24 w-24 rounded-full bg-zinc-500/15 blur-2xl" />
          </div>
        </div>
      </div>
    </section>
