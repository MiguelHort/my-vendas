      ...
      <div className="flex items-center gap-3">
        <Button
          ...
          className={cn(
            ...
            "border-white/20 bg-white/5 text-white hover:bg-blue-800 hover:text-white",
          )}
    ...
    <button
      ...
      className={cn(
        ...
        selected
          ...
          : "border-white/15 bg-white/5 hover:bg-blue-800 hover:border-white/25",
      )}
    >
...
function SelectField({
  ...
  return (
    <Select value={value} onValueChange={onValueChange} disabled={disabled}>
      <SelectTrigger
        className={cn(
          "h-12 rounded-2xl bg-blue-800 text-white border border-white/20",
    ...
    <div className="mb-5">
      ...
      <div className="mt-3 flex items-center justify-between text-xs">
        <div className="flex items-center gap-2">
          ...
          <span className={cn(current >= 1 ? "text-white" : "text-white/70")}>
            Dados básicos
          </span>
        </div>

        <div className="h-px flex-1 mx-3 bg-white/20" aria-hidden />
        ...
        <div className="flex items-center gap-2">
          ...
          <span className={cn(current >= 2 ? "text-white" : "text-white/70")}>
            Perfil
          </span>
        </div>
      </div>
...
export default function CardForm() {
  ...
  return (
    <div className="w-full px-1">
      {/* Card (glass) alinhado com SectionHome */}
      <Card className="mx-auto my-6 max-w-[620px] rounded-3xl border border-white/15 bg-blue-800 backdrop-blur shadow-xl">
        <CardContent className="p-6">
          {/* Header */}
          <div className="mb-6 text-center">
            <Badge className="mb-3 rounded-full bg-blue-800 text-white border border-white/20 px-4 py-1.5 text-[11px] backdrop-blur">
          ...
          {submitted && (
            <div className="space-y-6 text-center">
              ...
              <div className="rounded-2xl border border-white/15 bg-blue-800 p-5 text-left backdrop-blur">
              ...
              <Button
                className="w-full h-12 rounded-2xl text-base bg-blue-800 text-white hover:bg-white/15 border border-white/15"
              ...
              <div className="space-y-4">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={cn(
                      "pl-10 h-12 rounded-2xl bg-blue-800 text-white border border-white/20",
                      "placeholder:text-white/60",
                      "focus-visible:ring-2 focus-visible:ring-orange-500/40 focus-visible:border-orange-400",
                    )}
                    value={phone}
          ...
          {!submitted && step === 2 && (
            <div className="space-y-6">
              <div className="rounded-2xl border border-white/15 bg-blue-800 p-4 text-sm backdrop-blur">
              ...
              <div className="space-y-4">
                <div className="space-y-2">
                  ...
                  <SelectField
                    icon={<BriefcaseBusiness className="h-4 w-4 text-orange-500" />}
                ...
                <div className="space-y-2">
                  ...
                  <Card className="rounded-3xl border border-white/15 bg-blue-800 backdrop-blur">
                    <CardContent className="p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge className="rounded-full bg-blue-800 text-white border border-white/20">
                          mínimo: {minPeople}
                        </Badge>
                      </div>
                  ...
                  <div
                    className={cn(
                      ...
                      totalPeople >= minPeople
                        ? "border-white/15 bg-blue-800 text-white/80"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-white/70">
                        Usamos apenas para enviar sua cotação e te atender no WhatsApp.
                      </div>
                    </div>
                  </div>
                </div>
